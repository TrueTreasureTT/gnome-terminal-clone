...
function isCompoundComponent(type) {
    ...
    for (const key in type) {
        if (!isLikelyComponentType(type[key]))
            return false
    }
    return true
}
...
function isPlainObject(obj) {
    return (Object.prototype.toString.call(obj) === '[object Object]' && (obj.constructor === Object || obj.constructor === undefined))
}
...
export const __hmr_import = (module) => import(/* @vite-ignore */
